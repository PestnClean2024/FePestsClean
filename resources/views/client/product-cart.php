...
<section>
    <div class="div-cart">
        ...
        <div>
            <div class="div-text"><p class="cart-text">GIỎ HÀNG</p></div>
                            ...
                            <div class="col-mb-4">
                                <div class="card">
                                    ...
                                    <div class="element">
                                        ...
                                        <p class="price">2.415.000 <span>đ</span></p>
                                        <a href="/FePestsClean/resources/views/client/product-information-cart.php"><button class="add-cart">Giỏ hàng</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
