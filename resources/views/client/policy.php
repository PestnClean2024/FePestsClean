    ...
    <div class="tab-and-content-container">
        <ul class="nav nav-pills nav-fill" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="csbmtt-tab" data-bs-toggle="tab" data-bs-target="#csbmtt-tab-pane" type="button" role="tab" aria-controls="csbmtt-tab-pane" aria-selected="true">
                    Chính Sách Bảo Mật Thông Tin
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="csbhdt-tab" data-bs-toggle="tab" data-bs-target="#csbhdt-tab-pane" type="button" role="tab" aria-controls="csbhdt-tab-pane" aria-selected="false">
                    Chính Sách
                    Bảo Hành Đổi trả
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="csgnh-tab" data-bs-toggle="tab" data-bs-target="#csgnh-tab-pane" type="button" role="tab" aria-controls="csgnh-tab-pane" aria-selected="false">
                    Chính sách giao
                    nhận hàng
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="cstt-tab" data-bs-toggle="tab" data-bs-target="#cstt-tab-pane" type="button" role="tab" aria-controls="cstt-tab-pane" aria-selected="false">
                    Chính sách
                    thanh toán
                </button>
            </li>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="csbmtt-tab-pane" role="tabpanel" aria-labelledby="csbmtt-tab" tabindex="0">
                <!-- Tab Bảo Mật -->
                <div class="csbmtt-tab-content-container">
                    <h1>Chính Sách Bảo Mật Thông Tin</h1>
                    <img class="csbmtt-tab-content-header-img" src="../../../../FePestsClean/resources/images/policy/policy-tab-banner.png">
            ...
            <div class="tab-pane fade" id="csbhdt-tab-pane" role="tabpanel" aria-labelledby="csbhdt-tab" tabindex="0">
                ...
                <div class="csbmtt-tab-content-container">
                    ...
                    <img class="csbmtt-tab-content-header-img" src="../../../../FePestsClean/resources/images/policy/policy-tab-banner2.png">
                    <div class="csbmtt-tab-policy-content">
                        <!-- <div class="csbmtt-text-container">
                            <p class="csbmtt-tab-policy-content-headline">
                                CHÍNH SÁCH BẢO MẬT THÔNG TIN KHÁCH HÀNG:
                        ...
                        <p class="csbh-tab-normal-text">
                            Chào mừng bạn đến với Công Ty TNHH TM DV XNK NGUYỄN DUY (PestnClean).
                            Chúng tôi cam kết cung cấp các sản phẩm chất lượng và dịch vụ tốt nhất cho khách hàng của chúng tôi. Chính sách bảo hành đổi trả này mô tả các điều kiện và điều khoản áp dụng cho việc bảo hành, đổi trả sản phẩm của bạn khi mua hàng từ chúng tôi.
                        </p>
                        <p class="csbh-tab-normal-text">
                            Để đảm bảo quyền lợi của Quý khách trong việc đổi trả hàng và bảo hành sản phẩm, vui lòng kiểm tra hàng hoá, đối chiếu với chứng từ và phiếu bảo hành (nếu có) trước khi nhận hàng. Ngoài ra, vui lòng liên hệ với bộ phận bảo hành để biết thêm thông tin chi tiết về quy định bảo hành của sản phẩm:
                        <ul>
                            <li>
                                Email: info<u>@pestnclean.vn</u>
                            </li>
                            <li>
                                Hotline: 0868 36 36 00
                            </li>
                        </ul>
                        </p>
                    </div>
                    <div class="csbmtt-tab-policy-detail-content">
                        <div class="csbmtt-detail-text-container">
                            ...
                            <div class="text-and-ul-container">
                                <ul>
                                    <li class="csbh-tab-normal-text">Nếu sự cố được xác định là do nhà sản xuất gây ra và vẫn còn thời hạn bảo hành</li>
                                    <li class="csbh-tab-normal-text">Không có dấu hiệu can thiệp của bên thứ 03 (sửa chữa ngoài) trên sản phẩm.</li>
                                    <li class="csbh-tab-normal-text">Số sản phẩm, tem niêm phong và phiếu bảo hành của sản phẩm phải chính xác, không bị mất hoặc rách.</li>
                                    <li class="csbh-tab-normal-text">Hàng hóa không bị ảnh hưởng bởi các yếu tố môi trường như nước, hóa chất ăn mòn và nhiệt gây biến dạng.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="csbmtt-detail-text-container">
                            ...
                            <div class="text-and-ul-container">
                                <ul>
                                    <li>Những sản phẩm, mặt hàng không thể xác định được nguồn gốc. PestnClean có quyền từ chối bảo hành.</li>
                                    <li>Phiếu bảo hành của sản phẩm không còn hoặc đã hết hạn.</li>
                                    <li>Phiếu bảo hành bị rách, không còn, bị dán đè hoặc bị sửa đổi</li>
                                    <li>Phiếu bảo hành không bao gồm số serial và ngày xảy ra sự kiện.</li>
                                    <li>Số serial trên máy và phiếu bảo hành không trùng khớp nhau hoặc không thể tìm thấy.</li>
                                    <li>Sản phẩm bị hư hỏng do các tác động cơ học như rơi, vỡ, va đập, trầy xước, móp méo, ẩm ướt, hoen rỉ hoặc do hỏa hoạn, thiên tai</li>
                                    <li>Sản phẩm có dấu hiệu hư hỏng do côn trùng hoặc chuột bọ gây ra.</li>
                                    <li>Sản phẩm bị hư hỏng do sử dụng sách hướng dẫn không đúng hoặc sử dụng điện áp không phù hợp với quy định.</li>
                                    <li>Các phụ kiện kèm theo, chẳng hạn như điều khiển từ xa, pin điều khiển, dây nguồn, dây tín hiệu, đèn tín hiệu, tai nghe, quạt trên thiết bị, có thể bị hỏng và gây cháy.</li>
                                    <li>Tự ý tháo dỡ, thay đổi cấu trúc sản phẩm, sử dụng hướng dẫn sai hoặc sử dụng linh kiện không phù hợp.</li>
                                    <li>Nếu các sản phẩm được mua tại PestnClean quá hạn bảo hành, Quý khách có thể được công ty chúng tôi sửa chữa với chi phí khác.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="csbmtt-detail-text-container">
                        ...
                        <div class="csbmtt-detail-text-container">
                            ...
                            <div class="text-and-ul-container">
                                ...
                                <ul>
                                    <li>Sản phẩm phải còn trong tình trạng ban đầu và không có dấu hiệu đã được sử dụng hoặc cải tạo.</li>
                                ...
                                <ul>
                                    <li>Sau khi nhận được yêu cầu và xác minh thông tin, PestnClean sẽ tiến hành kiểm tra và đánh giá điều kiện hoàn trả của sản phẩm.</li>
                                    <li>Nếu đủ điều kiện, chúng tôi sẽ thực hiện hoàn tiền qua phương thức thanh toán ban đầu của khách hàng trong vòng 7 ngày làm việc.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="tab-pane fade" id="csgnh-tab-pane" role="tabpanel" aria-labelledby="csgnh-tab" tabindex="0">
                <!-- Tab Giao Nhận Hàng -->
                <div class="csbmtt-tab-content-container">
            ...
            <div class="tab-pane fade" id="cstt-tab-pane" role="tabpanel" aria-labelledby="cstt-tab" tabindex="0">
                <!-- Tab Thanh Toán -->
                <div class="csbmtt-tab-content-container">
