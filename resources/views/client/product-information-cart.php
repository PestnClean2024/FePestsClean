...
<section>
    <div class="div-cart">
        ...
        <div>
            <div class="div-text"><p class="cart-text-info">ĐIỀN THÔNG TIN</p></div>
            <div class="div-cart-product div-dap">
                <div class="div-cart-product">
                    <p class="sp-cart-info"><img src="/FePestsClean/resources/images/product-information-cart/product-information-cart.png" alt=""></p>
        ...
        <div class="div-cart-product div-cart-with">
            <div class="cart-div-1">
                <div class="div-cart-product justify">
                    ...
                    <p class="p-div-cart-text cart-p-with-1 p-center cart-color"><span class="p-center p-3">Giá</span></p>
                    <p class="p-div-cart-text cart-p-with-1 p-center cart-color"><span class="p-center p-2">Số lượng</span></p>
                    <p class="p-div-cart-text cart-p-with-1 cart-color"><span class="cart-p-with-2 cart-color">Tạm tính</span></p>
                </div>

                <hr class="hr-cart-product">

                <div class="cart-div-img div-cart-product">
                    <img src="/FePestsClean/resources/images/product/product-img-horz.png" alt="" class="cart-img-z">
                    <div class="div-cart-product cart-left">
                        <div class="d-btn">
                            <p class="p-div-cart-text cart-color">Hóa chất 3M™ Stainless Steel Cleaner & Polish 621ml (21Oz)</p>
            ...
            <div class="cart-div-2">
                ...
                <div class="cart-all-min">
                    ...
                    <div>
                        <button class="div-btn-cart-product" onclick="redirectTo('/FePestsClean/resources/views/client/pop-up.php')">Đặt hàng</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <form>
            <div class="from-info-flex top-1">
                <div class="form-group-info info-with">
                    ...
                    <input type="text" id="name" name="name" class="input-info top-min" placeholder="filled">
                </div>
                <div class="form-group-info info-with">
                    <label for="email" class="label-info">Email của bạn *</label>
                    <input type="email" id="email" name="email" class="input-info top-min" placeholder="filled">
                </div>
            </div>
            <div class="form-group-info top-1">
                ...
                <div class="phone-group-info">
                    ...
                    <input type="text" id="phone" name="phone" class="input-info top-min" placeholder="Eg: 988 523 146">
                </div>
            </div>
            <div class="form-group-info top-1">
            ...
            <div class="form-group-info top-1">
                ...
                <input type="text" id="additional-info" name="additional-info" class="input-info-max top-min" placeholder="filled">
            </div>
            <h3 class="label-info top-1">Địa chỉ giao hàng *</h3>
            <div class="form-group-info">
                <label for="address" class="title-info top-1">Địa chỉ*</label>
                <input type="text" id="address" name="address" class="input-info top-1 " placeholder="Điền địa chỉ của bạn">
            </div>
            <div class="form-group-info top-1">
                <label for="city" class="label-info">Thành phố/ Tỉnh</label>
                <input type="text" id="city" name="city" class="input-info top-min" placeholder="Điền thành phố/ tỉnh của bạn">
            </div>
            ...
            <div class="from-info-flex">
                <div class="info-with">
                    ...
                    <input type="text" id="company-name" name="company-name" class="input-info top-1 top-min" placeholder="Điền địa chỉ của bạn">
                </div>
                <div class="info-with">
                    <label for="tax-code" class="title-info">Nhập mã số thuế*</label>
                    <input type="text" id="tax-code" name="tax-code" class="input-info top-1 " placeholder="Điền địa chỉ của bạn">
                </div>
            </div>
            <div class="form-group-info">
                <label for="company-address" class="title-info top-1">Nhập địa chỉ công ty</label>
                <input type="text" id="company-address" name="company-address" class="input-info top-1 " placeholder="Điền thành phố/ tỉnh của bạn">
            </div>
            <h2 class="label-info top-1">Phương thức thanh toán *</h2>
            <div class="flex top-min">
                <p class="info-text">Giá giảm đang được giữ, vui lòng thanh toán trong </p><span class="timer-info">15:39</span>
            </div>
            <div class="payment-method-info top-1">
                <label class="radio-container-info gap-info-p">
                    ...
                    <img src="/FePestsClean/resources/images/product-information-cart/horz.png" alt="" class="img-info">
                    <span class="inf-sp">
            ...
            <div class="deposit-info top-1 ">
                ...
                <label for="agree-terms">Tôi đã đọc và đồng ý với <a href="#" class="p-a-info">điều khoản</a> và <a href="#" class="p-a-info">điều kiện</a> của Pestnclean</label>
            </div>
