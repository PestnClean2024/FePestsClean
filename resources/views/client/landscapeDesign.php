...
<section class="landscape-design-header">
    <div class="headline">
        <h1>Thiết kế & thi công cảnh quan</h1>
        <a href="#">
            <h4>Khám phá ngay</h4>
        </a>
    </div>
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p class="description">Thiết kế và thi công cảnh quan không chỉ mang lại vẻ đẹp cho không gian sống và làm việc, mà còn tạo môi trường sống trong lành, giúp nâng cao chất lượng cuộc sống. PestnClean tự hào là đơn vị cung cấp dịch vụ thiết kế và thi công cảnh quan chuyên nghiệp. Chúng tôi cam kết mang lại những không gian xanh mát, hài hòa với tự nhiên, phù hợp với nhu cầu và sở thích của Quý khách hàng.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="landscape-design-process wow animate__fadeInLeft" data-wow-delay="0.25s">
    ...
    <img src="../../images/landscapeDesign/landscape-design-process.png" class="img-fluid" alt="">
</section>
        ...
        <div class="row">
            <div class="card-item col-md-4 wow animate__fadeInUp" data-wow-delay="0.25s">
                ...
                <div class="card-footer">
                    <a href="#" class="view-more">
                        Xem thêm <img src="../../images/landscapeDesign/arrow-right.svg">
                    </a>
                </div>
            </div>
            <div class="card-item col-md-4 wow animate__fadeInDown" data-wow-delay="0.25s">
                ...
                <div class="wrapper">
                    ...
                    <p class="description">Thiết kế và trồng các loại hoa đa dạng theo mùa, phù hợp với cảnh quan và yêu cầu của khách hàng.</p>
                </div>
                <div class="card-footer">
                    <a href="#" class="view-more">
                        Xem thêm <img src="../../images/landscapeDesign/arrow-right.svg">
            ...
            <div class="card-item col-md-4 wow animate__fadeInUp" data-wow-delay="0.25s">
                ...
                <div class="wrapper">
                    ...
                    <p class="description">Lắp đặt các hệ thống tưới tiêu tự động giúp duy trì độ ẩm cần thiết cho cây trồng.</p>
                </div>
                <div class="card-footer">
                    <a href="#" class="view-more">
                        Xem thêm <img src="../../images/landscapeDesign/arrow-right.svg">
...
<section class="landscape-design-construction">
    ...
    <div class="construction-steps">
        <div class="row wow animate__bounceInLeft" data-wow-delay="0.25s">
            ...
            <div class="col-md-3">
                <img src="../../images/landscapeDesign/construction-step2.png" alt="" class="img-fluid">
            </div>
            <div class="col-md-3">
                <img src="../../images/landscapeDesign/construction-step3.png" alt="" class="img-fluid">
            </div>
            <div class="col-md-3">
        ...
        <div class="row wow animate__bounceInRight" data-wow-delay="0.25s">
            ...
            <div class="col-md-3">
                <img src="../../images/landscapeDesign/construction-step6.png" alt="" class="img-fluid">
            </div>
            <div class="col-md-3">
                <img src="../../images/landscapeDesign/construction-step7.png" alt="" class="img-fluid">
            </div>
        </div>
    </div>
