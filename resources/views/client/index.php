...
<!-- <section class="container-fluid p-0">
    ...
    <div id="homeCarouselBanner" class="carousel carousel-dark slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-indicators">
            ...
            <button type="button" data-bs-target="#homeCarouselBanner" data-bs-slide-to="2" aria-label="Slide 3"></button>
            <button type="button" data-bs-target="#homeCarouselBanner" data-bs-slide-to="3" aria-label="Slide 4"></button>
        </div>
        ...
        <button class="carousel-control-prev" type="button" data-bs-target="#homeCarouselBanner" data-bs-slide="prev">
            <div class="home-carousel-button-container"><svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                    <path d="M7.16663 16H25.8333" stroke="#868E96" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M7.16663 16L15.1666 24" stroke="#868E96" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M7.16663 16L15.1666 8" stroke="#868E96" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg></div>
            <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#homeCarouselBanner" data-bs-slide="next">
            <div class="home-carousel-button-container"><svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                    <path d="M7.45097 16H26.1176" stroke="#141718" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M18.1176 24L26.1176 16" stroke="#141718" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M18.1176 8L26.1176 16" stroke="#141718" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg></div>
            <span class="visually-hidden">Next</span>
        </button>
        <div class="home-icons-contact-container">
            <div class="home-icon-contact-container"><svg width="50" height="48" viewBox="0 0 70 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="Phone">
                        <path id="Vector" d="M34.1375 43.4297C38.7195 41.243 42.4152 37.5916 44.6222 33.0703C44.7825 32.7368 44.8518 32.3679 44.8235 32C44.7951 31.632 44.67 31.2777 44.4605 30.9719L39.9593 24.3313C39.7574 24.0379 39.6342 23.6988 39.6012 23.3458C39.5682 22.9928 39.6265 22.6373 39.7707 22.3125L45.1882 9.88126C45.3677 9.45639 45.6838 9.10143 46.0881 8.87105C46.4923 8.64066 46.9622 8.54762 47.4253 8.60626C50.5458 9.00026 53.4137 10.5013 55.4923 12.8285C57.571 15.1557 58.718 18.1496 58.7187 21.25C58.7187 30.8309 54.8567 40.0195 47.9823 46.7942C41.108 53.569 31.7843 57.375 22.0625 57.375C18.9165 57.3743 15.8786 56.2439 13.5171 54.1954C11.1557 52.1469 9.63257 49.3206 9.23277 46.2453C9.17328 45.7889 9.26768 45.3258 9.50146 44.9274C9.73523 44.5291 10.0954 44.2175 10.5265 44.0406L23.1675 38.7016C23.4919 38.5627 23.846 38.5046 24.1985 38.5324C24.551 38.5602 24.8912 38.673 25.189 38.8609L32.0351 43.2969C32.3448 43.4944 32.7006 43.6103 33.0687 43.6335C33.4368 43.6568 33.8048 43.5866 34.1375 43.4297Z" fill="#005CA9" stroke="#005CA9" stroke-width="3.39" stroke-linecap="round" stroke-linejoin="round" />
                    </g>
                </svg>
            </div>
    ...
    <div class="reasons-container">
        ...
        <div class="reasons-image-and-text-container">
            <div class="image-and-text-group">
                <img src="../../../../FePestsClean/resources/images/Home/reason-image.png" width="250" height="250">
                <h4>Hỗ trợ 24/7</h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
            </div>
            <div class="image-and-text-group">
                <img src="../../../../FePestsClean/resources/images/Home/reason-image2.png" width="250" height="250">
                <h4>ĐỘI NGŨ GIÀU
                    KINH NGHIỆM</h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
            </div>
    ...
    <div class="working-container">
        ...
        <div class="tab-container">
            <ul class="nav nav-tabs nav-fill">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Vệ sinh</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Diệt côn trùng</a>
                </li>
            </ul>
        </div>
        <div class="images-container">
            <div class="row">
                <div class="col">
                    <img src="../../../../FePestsClean/resources/images/Home/working-image.png" width="200" height="200">
                </div>
                <div class="col">
                    <img src="../../../../FePestsClean/resources/images/Home/working-image2.png" width="200" height="200">
                </div>
                <div class="col">
                    <img src="../../../../FePestsClean/resources/images/Home/working-image3.png" width="200" height="200">
                </div>
                <div class="col">
                    <img src="../../../../FePestsClean/resources/images/Home/working-image4.png" width="200" height="200">
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <img src="../../../../FePestsClean/resources/images/Home/working-image5.png" width="200" height="200">
                </div>
                <div class="col">
                    <img src="../../../../FePestsClean/resources/images/Home/working-image6.png" width="200" height="200">
                </div>
                <div class="col">
                    <img src="../../../../FePestsClean/resources/images/Home/working-image7.png" width="200" height="200">
                </div>
                <div class="col">
                    <img src="../../../../FePestsClean/resources/images/Home/working-image8.png" width="200" height="200">
                </div>
            </div>
        </div>
    </div>
