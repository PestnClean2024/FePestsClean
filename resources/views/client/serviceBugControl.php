    ...
    <div class="service-bug-control-text-and-video-container">
        <div class="row">
            <div class="col">
                ...
                <p>
                    Việc tìm được một <span class="p-bold">công ty kiểm soát côn trùng</span> hiệu quả cho nhà ở, các cơ sở, đơn vị kinh doanh là hết sức cần thiết. <span class="p-brand">PestnClean</span> tự hào là một đơn vị có nhiều năm kinh nghiệm trong lĩnh vực kiểm soát côn trùng. Chúng tôi với đội ngũ nhân viên lành nghề, được đào tạo kỹ càng về nhiều mặt (chuyên môn và thái độ phục vụ) cam kết sẽ cung cấp tới Quý khách hàng một dịch vụ chất lượng nhất.
                </p>
            </div>
            <div class="col">
        ...
        <div class="row">
            <div class="col">
                <div class="chart-image-and-text-container">
                    <img src="../../../../FePestsClean/resources/images/serviceBugControl/chart-image.png">
                    <p>Thông thường</p>
                </div>
            </div>
            <div class="col">
                <div class="chart-image-and-text-container">
                    <img src="../../../../FePestsClean/resources/images/serviceBugControl/chart-image2.png">
                    <p>Quy Trình</p>
                </div>
            </div>
        </div>
