    ...
    <div class="div-contact-cell">
        <div class="div-contact">
            ...
            <div class="div-zl-fb-call">
                <div class="div-fb boder-product">
                    <a href="#" class="font-text"><img src="/FePestsClean/resources/images/product/product-icon-fb.png" alt=""> Facebook</a>
                </div>
                <div class="div-zl boder-product">
                    <a href="#" class="font-text"><img src="/FePestsClean/resources/images/product/product-Zalo-logo.png" alt=""> Zalo</a>
                </div>
                <div class="div-call boder-product">
                    <a href="#" class="font-text" href="tel:+0909 123 456"><img src="/FePestsClean/resources/images/product/product-icon-zl.png" alt=""> 0909 123 456</a>
                </div>
            </div>
        </div>
        ...
        <div class="div-cell">
            <div class="div-cell-display div-contact-cell">
                <input type="text" name="" id="" placeholder="Tìm Kiếm sản phẩm" class="product-input"><i class="i-color fa-solid fa-magnifying-glass"></i>
