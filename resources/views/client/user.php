    ...
    <div class="wrapper row mt-5">
        <div class="aside col-xl-3">
            <div class="aside-main">
                <div>
                    <h5 style="color:#005ca9; font-size : 24px" class="fw-bold m-0 py-4"><i class="fa-solid fa-user pe-2"></i> Tài
                        khoản của tôi</h5>
                </div>
                <div>
        ...
        <div class="article col-xl-9">
            <div class="article-info">
                <div class="article-info-title align-items-center">
                    <h1>HỒ SƠ CÁ NHÂN</h1>
                </div>
                <form action="">
                    <div class="form">
                        ...
                        <div>
                            <label for="">Tên:</label>
                            <input type="text" name="" id="" class="form-control" placeholder="Tên khách hàng">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div class="d-flex gender">
                                <div class="form-check d-flex justify-content-center align-items-center">
                                    ...
                                    <label class="form-check-label ps-2" for="gender1">
                                        Nam
                                    </label>
                                </div>
                                <div class="form-check d-flex justify-content-center align-items-center ">
                                    <input class="form-check-input" type="radio" name="gender" id="gender2" checked>
                                    <label class="form-check-label ps-2" for="gender2">
                                        Nữ
                                    </label>
                                </div>
                                <div class="form-check d-flex justify-content-center align-items-center">
                                    <input class="form-check-input" type="radio" name="gender" id="gender3" checked>
                                    <label class="form-check-label ps-2" for="gender3">
                                        Khác
                                    </label>
                                </div>
                            </div>
            ...
            <div class="article-address mb-5">
                <div class="article-address-title mb-4 d-flex align-items-center justify-content-between">
