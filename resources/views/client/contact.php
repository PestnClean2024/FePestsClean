        ...
        <div class="col-md-3 method">
            ...
            <ul class="list-unstyled">
                ...
                <li class="nav-item mt-3 mb-3">
                    <a href="#" class="nav-link">
                        <img src="../../images/Contact/zalo.png">
                        Zalo
                    </a>
                </li>
                <li class="nav-item">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 mb-3">
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <input type="number" class="form-control" placeholder="Eg: 988 523 146" aria-label="Username" aria-describedby="addon-wrapping">
                        </div>
                    </div>
                    <div class="form-group col-md-12 mb-3">
                    ...
                    <div class="form-group col-md-12 mb-3 d-flex align-items-center">
                        ...
                        <span class="terms-of-service">Tôi đã đọc và đồng ý với <a href="#">điều khoản</a> và <a href="#">điều kiện</a> của Pestnclean</span>
                    </div>
                    <hr class="mb-3">
