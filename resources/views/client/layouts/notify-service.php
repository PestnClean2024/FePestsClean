...
</div> đoạn code cũ nếu ko dúng sữa lại--> 
<div class="footer">
    <div class="footer-log-re">
        <p class="footer-p-register text-uppercase">đăng ký để tư vấn dịch vụ & sản phẩm</p>
        <form id="collect-info">
          <hr class="hr-footer">
          <div class="size">
            ...
            <div  class="div-top">
              <label for="" class="label-input">Bạn đang quan tâm</label>
              <div  class="div-top">
                <select id="cars" name="cars" class="text-select ">
                        <option value="volvo" >Please Select</option>
                        <option value="saab">Saab</option>
            ...
            <div  class="div-top">
              <label for="" class="label-input">Thông tin thêm</label>
              <div  class="div-top">
                <input type="text" name="" id="" placeholder="filled" class="text-select input-text">
              </div>
            </div>
